            ...
            <div class="col-md-12">
                <div class="card tdb-card" style="height: unset!important;padding-top: unset!important;">
                    <div class="row" style="padding-top: 1%;padding-bottom: 1%;">
                        ...
                        <div class="col-md-4"><strong><span style="float: left;">Url</span></strong>
                        </div>
                        <div class="col-md-2"><strong><span style="float: left;">Date</span></strong>
                        </div>
                        <div class="col-md-1"><strong><span style="float: left;">Time</span></strong>
                        </div>
                        <div class="col-md-2">
                ...
                @php $i++; @endphp   
                    <div class="card-body" style="height: unset!important;background-color: #eee;">
                        <div class="row" style="padding-top: 1%;padding-bottom: 1%;">
                            ...
                            <div class="col-md-4"><span style="float: left;word-break: break-all;">{{$row->url}}</span>
                            </div>
                            <div class="col-md-2"><span style="float: left;line-height: 35px;">{{date("d-m-Y", strtotime($row->date))}}</span>
                            </div>
                            <div class="col-md-1"><span style="float: left;line-height: 35px;">{{date("H:i A", strtotime($row->time))}}</span>
                            </div>
                            <div class="col-md-2">
                                <span style="float: left;line-height: 35px;"><a href="{{$row->url}}"><button class="btn btn-info">Start</button></a></span>
                            </div>
